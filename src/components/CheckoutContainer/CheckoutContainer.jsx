...
export default function CheckoutContainer () {
    ...
    const handleSubmit = async (e) => {
        ...
        // antes de hacer el addDoc, verifico que haya stock suficiente para todos los ptoductos
        for (const itemInCart of cart) {
            ...
            if (productData.stock < itemInCart.quantity) {
                ...
                //el return corta el flujo de toda la función, si no hay stock suficiente, no hago el addDoc
                return;
            }
        }
